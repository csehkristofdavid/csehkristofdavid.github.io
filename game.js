...
function valaszt(input){
    ...
    ` Gép: <span> ${choices[num].toUpperCase()} </span>`;

    document.getElementById("jatekős_valasztas").innerHTML = 
    ` Te: <span> ${input.toUpperCase()} </span>`;
    ...
    document.getElementById("jatekos_pont").innerHTML = jatekos_pont;
}